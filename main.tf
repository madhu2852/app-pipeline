...
#   count = length(data.aws_instances.public_alb_palo_alto)
#   target_group_arn = aws_lb_target_group.public_alb_app[count.index].arn
#   target_id        = data.aws_instances.public_alb_palo_alto[count.index].id
# }
